...
const approveBleggsToRouter = async (bleggsAmount, callerAddress, socketId) => {
  try {
    ...
    return "Error while approving Bleggs to Router";
  }
};
...
const transferBleggs = async (recepiantAddress, bleggsAmount, socketId) => {
  try {
    ...
    return "Error while transferBleggs. Maybe insufficient Bleggs token in your wallet.";
  }
};
...
const transferBnb = async (recepiantAddress, bnbAmount, socketId) => {
  try {
    ...
    return "Error while transfering BNB. Maybe insufficient BNB in your wallet";
  }
};
...
const swapExactETHForTokens = async (
  ...
  try {
    ...
    return "Error while exploring swapExactETHForTokens";
  }
};
...
const swapExactTokensForETHSupportingFeeOnTransferTokens = async (
  ...
  try {
    ...
    return "Error while exploring swapExactTokensForETHSupportingFeeOnTransferTokens";
  }
};
